...
function makeVotedResult(overrides = {}) {
  return {
    ...
    intercepted: 8,
    interceptedQual: null,
    interceptedQual_num: null,
    interceptedConfidence: 0.6,
    seaImpact: null,
    seaImpactQual: null,
    seaImpactQual_num: null,
    sea_confidence: 0,
    openAreaImpact: null,
    openAreaImpactQual: null,
...
describe("contradiction detection", () => {
  ...
  function describeContradictions(_extractions, voted) {
    ...
    if (
      voted.rocketCountMin !== null &&
      voted.rocketCountMax !== null &&
    ...
    if (voted.interceptedConfidence < 0.5 && voted.intercepted !== null) {
      issues.push(
        `Intercepted count (${
          voted.intercepted
    ...
    if (voted.hits_confidence < 0.5 && voted.hitsConfirmed !== null) {
      issues.push(
        `Hits confirmed (${
          voted.hitsConfirmed
